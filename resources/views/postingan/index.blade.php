...
@section('content')
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="fw-normal">Dibuat Oleh</th>
                    ...
                    @else
                        @foreach ($postingan as $postingan)
                            <tr>
                                ...
                                <td>{{ $postingan->mahasiswa->nama }}</td>
                                <td class="text-center">
                                    <form action="{{ route('postingan.destroy', $postingan->id) }}" method="POST">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-sm" onclick="confirmatinModal({{ $postingan->id }})">
    ...
    <script type="text/javascript">
        ...
        const confirmatinModal = (id) => {
            ...
            var url = '{{ route('postingan.destroy',':id') }}';
